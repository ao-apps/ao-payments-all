...
def upstreamProjects = [
  ...
  'authorizeNet', // <groupId>com.aoapps</groupId><artifactId>ao-payments-authorizeNet</artifactId>
  'payflowPro', // <groupId>com.aoapps</groupId><artifactId>ao-payments-payflowPro</artifactId>
  'stripe', // <groupId>com.aoapps</groupId><artifactId>ao-payments-stripe</artifactId>
  'test', // <groupId>com.aoapps</groupId><artifactId>ao-payments-test</artifactId>
  'usaepay', // <groupId>com.aoapps</groupId><artifactId>ao-payments-usaepay</artifactId>
]
